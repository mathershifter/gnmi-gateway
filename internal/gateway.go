...
import (
	...
	"github.com/openconfig/gnmi-gateway/internal/clustering"
	"github.com/openconfig/gnmi-gateway/internal/configuration"
	"github.com/openconfig/gnmi-gateway/internal/connections"
	"github.com/openconfig/gnmi-gateway/internal/exporters"
	"github.com/openconfig/gnmi-gateway/internal/loaders"
	"github.com/openconfig/gnmi-gateway/internal/loaders/cluster"
	"github.com/openconfig/gnmi-gateway/internal/server"
	"github.com/openconfig/gnmi-gateway/internal/stats"
)
...
func (g *Gateway) StartGateway(opts *StartOpts) error {
	...
	if len(g.config.ZookeeperHosts) > 0 {
...
func (z *ZKLogger) Printf(a string, b ...any) {
