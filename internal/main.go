...
import (
	...
	_ "github.com/openconfig/gnmi-gateway/internal/exporters/all"
	_ "github.com/openconfig/gnmi-gateway/internal/loaders/all"
)
...
func Main() {
	...
	if PrintVersion {
		fmt.Printf("gnmi-gateway version %s (Built %s)\n", Version, Buildtime)
		os.Exit(0)
	}
